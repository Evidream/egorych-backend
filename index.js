...
app.post("/chat", async (req, res) => {
  ...
  try {
    ...
    if (user.message_count >= limit) {
      return res.json({
        reply: "Слушай, а чё мы как не родные то? Зарегайся пыренько — там рели 5 сек. Хоть познакомимся, а то как два гуся! Регайся скорее и продолжим лялякать: https://egorych.ai/members/signup/group/adm1q1c2mc9ttfv-start"
      });
    }
