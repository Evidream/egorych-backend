...
// === КЛЮЧИ ===
const OPENAI_API_KEY = "sk-svcacct-..."; // твой ключ, не трогай
const ELEVENLABS_API_KEY = "sk_6e00...";
...
console.log("✅ ElevenLabs:", ELEVENLABS_VOICE_ID);
...
app.post("/chat", async (req, res) => {
  ...
  try {
    ...
    if (user.message_count >= limit) {
      return res.json({ reply: "🥲 Лимит сообщений исчерпан." });
    }
